...
namespace MuiltyShop.Areas.Product.Controllers
{
    ...
    public class CategoryProductController : Controller
    {
        ...
        // GET: Product/CategoryProduct/Details/5
        ...
        private void CreateSelectItems(List<CategoryProductModel> source, List<CategoryProductModel> des, int level)
        {
            string prefix = string.Concat(Enumerable.Repeat("----", level));
            foreach (var category in source)
            {
                // category.Title = prefix + " " + category.Title;
                des.Add(new CategoryProductModel()
                {
                    Id = category.Id,
        ...
        // GET: Product/CategoryProduct/Create
        public async Task<IActionResult> CreateAsync()
        {
            ...
            var items = new List<CategoryProductModel>();
        ...
        // POST: Product/CategoryProduct/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Slug,ParentCategoryId")] CategoryProductModel category)
        {
        ...
        // GET: Product/CategoryProduct/Edit/5
        ...
        // POST: Product/CategoryProduct/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Slug,ParentCategoryId")] CategoryProductModel category)
        {
            if (id != category.Id)
            {
                return NotFound();
            ...
            if (canUpdate && category.ParentCategoryId != null)
            {
                ...
                // Func check Id 
                Func<List<CategoryProductModel>, bool> checkCateIds = null;
                checkCateIds = (cates) =>
                {
        ...
        // GET: Product/CategoryProduct/Delete/5
        ...
        // POST: Product/CategoryProduct/Delete/5
